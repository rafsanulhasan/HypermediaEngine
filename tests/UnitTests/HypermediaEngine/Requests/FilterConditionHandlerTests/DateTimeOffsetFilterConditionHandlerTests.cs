...
internal sealed class DateTimeOffsetFilterConditionHandlerTests : TestBase
{
    [Test]
    ...
    public void Handle_WhenDateTimeOffsetValueProvidedWithValidOperators_ReturnsExpectedDynamicLinqString(
        string opStr,
    ...
    public void Handle_WhenDateTimeOffsetValueProvidedWithInvalidOperators_ThrowsNotSupportedException(
        string opStr,
        string valueStr)
    {
        // Arrange
