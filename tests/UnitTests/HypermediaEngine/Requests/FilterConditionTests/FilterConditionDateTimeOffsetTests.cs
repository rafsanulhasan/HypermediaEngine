...
public sealed class FilterConditionDateTimeOffsetTests
{
    ...
    public async Task ToString_DateTimeOffsetValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
    ...
    public async Task ToString_DateTimeOffsetValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        DateTimeOffset fieldValue = _faker.Date.RecentOffset();
