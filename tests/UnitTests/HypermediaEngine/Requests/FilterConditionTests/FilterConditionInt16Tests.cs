...
public sealed class FilterConditionInt16Tests
{
    ...
    public void ToString_ShortValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
    ...
    public void ToString_ShortValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
