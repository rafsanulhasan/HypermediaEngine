...
public sealed class FilterConditionBoolTests
{
    ...
    public async Task ToString_BoolValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
    ...
    public async Task ToString_BoolValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        bool fieldValue = _faker.Random.Bool();
