...
public sealed class FilterConditionUInt32Tests
{
    ...
    public async Task ToString_UInttValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        uint fieldValue = _faker.Random.UInt();
    ...
    public async Task ToString_UIntValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        uint fieldValue = _faker.Random.UInt();
