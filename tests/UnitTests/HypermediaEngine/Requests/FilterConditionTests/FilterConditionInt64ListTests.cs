...
public sealed class FilterConditionInt64ListTests
{
    ...
    public async Task ToString_Int64ListValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        List<long> fieldValues = [.. Enumerable.Range(1, 5).Select(_ => _faker.Random.Long())];
    ...
    public async Task ToString_Int64ListValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        List<long> fieldValue = [.. Enumerable.Range(1, 5).Select(_ => _faker.Random.Long())];
        FilterOperator op = opStr!;
        FilterCondition condition = new(
            field,
            op,
