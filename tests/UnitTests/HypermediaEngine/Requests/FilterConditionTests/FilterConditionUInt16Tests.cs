...
public sealed class FilterConditionUInt16Tests
{
    ...
    public void ToString_UShortValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
    ...
    public void ToString_UShortValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        ushort fieldValue = _faker.Random.UShort();
