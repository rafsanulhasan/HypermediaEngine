...
public sealed class FilterConditionInt32ListTests
{
    ...
    public void ToString_Int32ListValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
    ...
    public void ToString_Int32ListValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
