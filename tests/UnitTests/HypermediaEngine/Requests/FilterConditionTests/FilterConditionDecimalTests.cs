...
public sealed class FilterConditionDecimalTests
{
    ...
    public async Task ToString_DecimalValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        decimal fieldValue = _faker.Random.Decimal();
    ...
    public async Task ToString_DecimalValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        decimal fieldValue = _faker.Random.Decimal();
