...
public sealed class FilterConditionDecimalTests
{
    ...
    public void ToString_DecimalValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
    ...
    public void ToString_DecimalValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        decimal fieldValue = _faker.Random.Decimal();
