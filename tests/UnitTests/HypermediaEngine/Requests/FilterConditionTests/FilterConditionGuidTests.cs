...
public sealed class FilterConditionGuidTests
{
    ...
    public async Task ToString_GuidValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        Guid fieldValue = _faker.Random.Guid();
    ...
    public async Task ToString_GuidValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        Guid fieldValue = _faker.Random.Guid();
