...
public sealed class FilterConditionGuidTests
{
    ...
    public void ToString_GuidValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
    ...
    public void ToString_GuidValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        Guid fieldValue = _faker.Random.Guid();
