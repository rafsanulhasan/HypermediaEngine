...
public sealed class FilterConditionUInt16ListTests
{
    ...
    public async Task ToString_UInt16ListValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        List<ushort> fieldValues = [.. Enumerable.Range(1, 5).Select(_ => _faker.Random.UShort())];
    ...
    public async Task ToString_UInt16ListValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        List<ushort> fieldValue = [.. Enumerable.Range(1, 5).Select(_ => _faker.Random.UShort())];
        FilterOperator op = opStr!;
        FilterCondition condition = new(
            field,
            op,
