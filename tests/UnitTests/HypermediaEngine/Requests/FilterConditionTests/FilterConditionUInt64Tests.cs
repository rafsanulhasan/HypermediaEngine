...
public sealed class FilterConditionUInt64Tests
{
    ...
    public async Task ToString_ULongValueWithCompatibleOperators_ReturnsConditionString(
        string opStr,
        string expectedOp)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        ulong fieldValue = _faker.Random.ULong();
    ...
    public async Task ToString_ULongValueAndUnsupportedOp_ThrowsNotSupportedException(string opStr)
    {
        // Arrange
        string field = _faker.Random.AlphaNumeric(10);
        ulong fieldValue = _faker.Random.ULong();
