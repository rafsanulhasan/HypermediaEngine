...
- Flag design flaws, not just implementation issues
- Suggest specific improvements, not vague recommendations
- Check for scalability and reliability concerns
- Note performance bottlenecks only when they matter at scale