...
tools: Bash, Glob, Grep, Read, TaskStop, WebFetch, WebSearch, PushNotification, Skill, TaskCreate, TaskGet, TaskList, TaskUpdate, ToolSearch, mcp__ide__getDiagnostics, mcp__ide__executeCode, CronCreate, CronDelete, CronList, EnterWorktree, ExitWorktree, RemoteTrigger, ScheduleWakeup, Monitor
model: opus
color: green
memory: project
---
