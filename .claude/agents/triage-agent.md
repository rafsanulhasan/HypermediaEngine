...
tools: Agent, Bash, Glob, Grep, Read, Write, Skill, TodoWrite, ToolSearch, WebSearch, WebFetch, PushNotification, TaskCreate, TaskGet, TaskList, TaskUpdate, TaskStop, EnterPlanMode, ExitPlanMode
model: opus
color: purple
memory: project
---
...
```
Agent("skill-manager", prompt: "update-skill implement-feature: add security scan phase after mutation testing")
Agent("skill-manager", prompt: "create-agent <name>")
```
