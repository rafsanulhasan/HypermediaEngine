...
**How to apply:** when reviewing or modifying the triage skill, ensure both `.claude/skills/triage/SKILL.md` and `.github/skills/triage/SKILL.md` carry the full chain table including product-manager and agent-manager rows. Add new lifecycle/ownership routes to the table whenever a new owning agent is introduced.
