...
agent: "agent"
argument-hint: "Path to requirements document or describe the problem to design"
---
...
3. Response exits as `{ data, error }` from <exit point>.
...
After presenting the document, state in one sentence which component the implementer should build first and why.
