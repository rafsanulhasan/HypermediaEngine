---
description: "Structured requirement elicitation methodology for the HypermediaEngine project. Guides a staged Q&A session and produces a requirements document ready for the software-architect."
agent: "agent"
...
When all four stages are complete, produce a **Requirements Document** using this structure:
...
After presenting the document, summarize in one sentence what the software-architect should focus on first.
