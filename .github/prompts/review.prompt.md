...
agent: "agent"
argument-hint: "Branch name, PR number, commit range, or file list to review"
---
...
4. Identify any new logic paths not covered by the existing test suite and flag them as **Warning** items.
...
If structural concerns require an ADR, note them as **Blocker** items and flag for the software-architect.
